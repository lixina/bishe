...
$(function(){
	 ...
	 $(".btn-primary").click(function(){
		 ...
		 $.get("/saveusermsg",{"userphone":userphone,"useraddress":useraddress,"username":username},function(msg){
			 if(msg == "1111"){
				 /* $("#modal-container-606308").attr("aria-hidden","true"); */
			 }
		 })
	 })
		//点击购物袋
...
<th style="border: groove;text-align: center;"><input type="button" value="${orderlist.orderstate}" style="border:false;background-color: black;color: white;" onclick="imsure('${orderlist.orderstate}',${orderlist.ordernum},${orderlist.username})"/></th></tr>
</c:forEach>
		</table>
	</div>
	<div>
