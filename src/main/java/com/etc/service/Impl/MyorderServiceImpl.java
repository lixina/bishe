...
public boolean addtomyorder(Date orderdate, String orderstate,
		String goodsname, double ordertotalprice, int goodscount,
		String username, int ordernum, double goodsprice) {
	//插入订单表
